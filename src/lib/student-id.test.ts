...
describe("classify", () => {
  it("puts each mark in the right band", () => {
    expect(classify(78).short).toBe("1st");
    expect(classify(70).short).toBe("1st");
    expect(classify(69).short).toBe("2:1");
    expect(classify(52).short).toBe("2:2");
    expect(classify(40).short).toBe("3rd");
    expect(classify(39).short).toBe("Fail");
    expect(classify(0).short).toBe("Fail");
  });
